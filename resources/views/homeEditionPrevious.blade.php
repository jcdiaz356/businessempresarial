                                    ...
                                    @foreach($notesCompany as $index=>$note)
                                        <div class="item  @if ($active->note_id === $note->id) {{ "active" }} @endif" >
                                            ...
                                            <div class="carousel-caption">
                                                <a href="{{ route('note_show_path_editions_previous',[$note->edition_id,$note->category_id,$note->id]) }}"> {{ $note->title }}</a>
                                            </div>
                                        </div>
                                    @endforeach
...
<!--SEGUNDA COLUMNA-->
    ...
    <!--PUBLICIDAD-->
        <div class="row pt">
            <div class="col-md-12">
                <a href="https://www.schneider-electric.com/tools/registration/promo/PY/ls/getpromo/43771b/"  target="_blank"><img class="img-responsive img-publicidad" src="media/publicity/gift-Prefab-534x160.gif" alt=""/></a>
            </div>
        </div>
    </div>
    </div>
...
<div class="col-md-6">
    ...
    <div class="row pt">
        <div class="col-md-12">
            ...
            {{-- --------------------PUBLICIDAD CISCO- --------------------------------------}}
            <a href="http://www.cisco.com/web/LA/soluciones/collaboration/index.html" target="_blank">
                <img class="img-responsive img-publicidad" src="media/publicity/banner_digital-animado.gif" alt=""/>
            </a>
...
<div>
    <div class="embed-responsive-video-interior embed-responsive embed-responsive-16by9">
        <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/VCUqbMnwvHM" allowfullscreen></iframe>
    </div>
</div>
</div>
</div>
