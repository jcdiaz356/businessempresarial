...
<header>
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <!--LOGOTIPO-->
                <a class="logo" href="{{ route('home_editions_previous',$edition[0]) }}" title="Businessempresarial">
                </a>
                <!--fecha-->
                <div class="fecha">
                    <span id="fecha"></span>
                ...
                <nav class="navbar navbar-default">
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        <ul class="nav navbar-nav">
                            <li class="@if ($activeMenu  == 0) {{ "active" }}  @endif"><a href="{{ route('home_editions_previous',$edition[0]) }}">PORTADA <span class="sr-only">(current)</span></a></li>
                            @foreach($categories as $index => $category)
                                ...
                                @elseif($category->id == 10)
                                    <li class=" @if ($activeMenu  == $category->id) {{ "active" }}  @endif "><a href="{{ route('note_publication_agenda_show_path_editions_previous',[$edition[0]->id,$category->id]) }}"> Agenda y publicaciones</a></li>
                                ...
                                @else
                                    <li class=" @if ($activeMenu  == $category->id) {{ "active" }}  @endif "><a href="{{ route('category_show_path_editions_previous',[$edition[0]->id,$category->id]) }}">{{ $category->name }}</a></li>
                                @endif
                            @endforeach
